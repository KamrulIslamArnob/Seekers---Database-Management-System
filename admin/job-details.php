...
<head>
    <meta charset="utf-8" />
    <title>Job Details | Jobcy - Admin & Dashboard Template</title>
...
<body class="bg-white dark:bg-neutral-800">
    ...
    <div class="main-content">
        <div class="page-content">
                                    ...
                                    <nav class="inline-block" aria-label="breadcrumb text-center">
                                        <ol class="flex flex-wrap justify-center text-sm font-medium uppercase">
                                            ...
                                            <li class="active" aria-current="page"><i
                                                    class="bx bxs-chevron-right align-middle px-2.5"></i>Job Details
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
            ...
            <!-- Start grid -->
            <section class="py-20">
           <h1><small>Job Title: </small><?php echo $jobData['jobTitle']; ?></h1>
           ...
           <form   action="approve-job.php?job_id=<?php echo $jobData['id']; ?>" method="post">
            <input type="hidden" name="job_id" value="<?php echo $jobData['id']; ?>">
            <button type="submit" class="btn btn-success text-dark" onclick="return confirm('Are you sure you want to approve this job?')">
                Approve
            </button>
        </form>
