...
$quizes = $jobManager->getAllJobQuizes();
?>
...
<head>
    <meta charset="utf-8" />
    <title>Manage Quizes | Jobcy - Admin & Dashboard Template</title>
...
<body class="bg-white dark:bg-neutral-800">
                    ...
                    <div class="grid">
                        <div class="col-span-12">
                            <div class="text-center text-white">
                                <h3 class="mb-4 text-[26px]">Manage Quizes</h3>
                                <div class="page-next">
                                    <nav class="inline-block" aria-label="breadcrumb text-center">
                                        <ol class="flex flex-wrap justify-center text-sm font-medium uppercase">
                                            ...
                                            <li class="active" aria-current="page"><i
                                                    class="bx bxs-chevron-right align-middle px-2.5"></i>Manage Quizes
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <section class="py-20">
                <form action="add-quize.php" method="post">
                    <button type="submit" class="btn btn-success text-dark">
                        Add Quiz
                    </button>

                    <ul>
                        <?php foreach ($quizes as $index => $quize): ?>
                            <?php echo '<br>' ?>
                            <li><?php echo ($index + 1) . '. ' . $quize['question']; ?></li>
                        <?php endforeach; ?>
                    </ul>
                </form>
            </section>
