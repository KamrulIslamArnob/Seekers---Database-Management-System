...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (!in_array(true, array_column($upload_results, 'error'))) {
        ...
        $stmt = $link->prepare("INSERT INTO `skills` (`user_id`, `skill_name`, `skill_level`) VALUES (?, ?, ?)");

        try {
            $stmt->execute([ $user_id, $skill_name, $skill_level ]);
        } catch (Exception $e) {
        ...
        if (!isset($error)){
            ...
            header("location: skills-read.php?skill_id=$new_id");
        } else {
                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                                            ...
                                            <input type="text" name="user_id" id="user_id" maxlength="50" class="form-control" value="<?php echo $userid ?>" readonly>
                        ...
                        <a href="skills-index.php" class="btn btn-secondary"><?php translate('Cancel') ?></a>
                    </form>
