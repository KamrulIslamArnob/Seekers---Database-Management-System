...
if(isset($_POST["service_id"]) && !empty($_POST["service_id"])){
    ...
    $fileColumns = [];
    if (isset($tables_and_columns_names['services']['columns'])) {
        foreach ($tables_and_columns_names['services']['columns'] as $columnName => $columnDetails) {
    ...
    if (!empty($fileColumns)) {
        foreach ($fileColumns as $columnName) {
            ...
            if ($stmt = mysqli_prepare($link, $sql)) {
                // Set parameters
                $param_id = trim($_POST["service_id"]);
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?service_id=" . $_GET["service_id"]; ?>" method="post">
