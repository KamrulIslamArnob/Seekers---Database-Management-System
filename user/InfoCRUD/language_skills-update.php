...
if(isset($_POST["language_id"]) && !empty($_POST["language_id"])){
    ...
    if (!in_array(true, array_column($upload_results, 'error'))) {
        ...
        $stmt = $link->prepare("UPDATE `language_skills` SET `language_name`=?,`id`=? WHERE `language_id`=?");

        try {
            $stmt->execute([ $language_name, $id, $language_id  ]);
        } catch (Exception $e) {
        ...
        if (!isset($error)){
            header("location: language_skills-read.php?language_id=$language_id");
        } else {
...
if(isset($_GET["language_id"]) && !empty($_GET["language_id"])){
    ...
    $sql = "SELECT * FROM `language_skills` WHERE `language_id` = ?";
                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                                            ...
                                            <input type="text" name="language_name" id="language_name" maxlength="255" class="form-control" value="<?php echo @$language_name; ?>">
                                        </div>
						<div class="form-group">
                        ...
                        <hr>
                        <p>
                            <a href="language_skills-read.php?language_id=<?php echo $_GET["language_id"];?>" class="btn btn-info"><?php translate('View Record') ?></a>
