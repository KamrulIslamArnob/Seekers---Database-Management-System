...
if(isset($_POST["skill_id"]) && !empty($_POST["skill_id"])){
    ...
    $fileColumns = [];
    if (isset($tables_and_columns_names['skills']['columns'])) {
        foreach ($tables_and_columns_names['skills']['columns'] as $columnName => $columnDetails) {
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if (!isset($error)){
            ...
            header("location: skills-index.php");
        }
    }
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?skill_id=" . $_GET["skill_id"]; ?>" method="post">
                    <?php print_error_if_exists(@$error); ?>
                        <div class="alert alert-danger fade-in">
                            <input type="hidden" name="skill_id" value="<?php echo trim($_GET["skill_id"]); ?>"/>
