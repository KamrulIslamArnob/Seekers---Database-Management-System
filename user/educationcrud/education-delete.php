...
if(isset($_POST["edu_id"]) && !empty($_POST["edu_id"])){
    ...
    $fileColumns = [];
    if (isset($tables_and_columns_names['education']['columns'])) {
        foreach ($tables_and_columns_names['education']['columns'] as $columnName => $columnDetails) {
    ...
    $sql = "DELETE FROM `education` WHERE `edu_id` = ?";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?edu_id=" . $_GET["edu_id"]; ?>" method="post">
                    <?php print_error_if_exists(@$error); ?>
                        <div class="alert alert-danger fade-in">
                            <input type="hidden" name="edu_id" value="<?php echo trim($_GET["edu_id"]); ?>"/>
