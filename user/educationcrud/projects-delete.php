...
if(isset($_POST["project_id"]) && !empty($_POST["project_id"])){
    ...
    $fileColumns = [];
    if (isset($tables_and_columns_names['projects']['columns'])) {
        foreach ($tables_and_columns_names['projects']['columns'] as $columnName => $columnDetails) {
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?project_id=" . $_GET["project_id"]; ?>" method="post">
                    ...
                    <p>
                        ...
                        <a href="projects-update.php?project_id=<?php echo $_GET["project_id"];?>" class="btn btn-warning"><?php translate('Update Record') ?></a>
