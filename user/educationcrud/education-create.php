...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (!in_array(true, array_column($upload_results, 'error'))) {
        ...
        $stmt = $link->prepare("INSERT INTO `education` (`user_id`, `name`, `degree`, `city`, `start_date`, `end_date`, `description`) VALUES (?, ?, ?, ?, ?, ?, ?)");

        try {
            $stmt->execute([ $user_id, $name, $degree, $city, $start_date, $end_date, $description ]);
        } catch (Exception $e) {
        ...
        if (!isset($error)){
            ...
            header("location: education-read.php?edu_id=$new_id");
        } else {
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <a href="education-index.php" class="btn btn-secondary"><?php translate('Cancel') ?></a>
                    </form>
