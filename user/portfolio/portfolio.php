...
if ($projectsResult->num_rows > 0) {
  $projectsData = $projectsResult->fetch_all(MYSQLI_ASSOC);
} else {
  $projectsData = []; 
}
?>
...
<div class="ml-10">
  ...
  <div class="toggle__navigation fixed ltr:left-[30px] rtl:right-[30px] top-[30px] z-50 pointer-events-none md:hidden">
    ...
    <ul class="toggle__nav--menu relative z-20 invisible text-left pt-[53px] pb-[22px]">
      ...
      <li class="active?$userId=<?php echo $userid; ?>">
      ...
      <div class="container mx-auto">
        <div class="text-center relative">
          ...
          <span
            ...
            My <span class="text-accent1">Projects</span></span>
        </div>
      </div>
    </section>
            ...
            <a href="#" class="popup-modal--open">
                ...
                <div class="w-full portfolio__image--card">
                    <img class="w-full transition duration-300"
                        src="https://en.idei.club/uploads/posts/2023-06/thumbs/1686701095_en-idei-club-p-orange-bg-dizain-pinterest-13.png" alt="">
                </div>
            </a>
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 my-6">
                            <div class="space-y-2">
                                <p class="dark:text-white flex items-center">
                                    ...
                                    Project :&nbsp;
                                    <span class="font-medium"><?php echo $project['project_name']; ?></span>
                                </p>
                                <p class="dark:text-white flex items-center">
                                    <span class="mr-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24"
                                    ...
                                    Languages :&nbsp;
                                    <span class="font-medium"><?php echo $project['languages']; ?></span>
                                </p>
                            </div>
                            ...
                            <div class="space-y-2">
                                <p class="dark:text-white flex items-center mt-2 lg:mt-0  ">
                                    ...
                                    Client :&nbsp; <span class="font-medium"><?php echo $project['Client']; ?></span>
                                </p>
                                <p class="dark:text-white flex items-center">
                                    <span class="mr-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24"
                        ...
                        <div class="pr-3">
                            <img class="max-w-full h-auto rounded-xl mt-6 mx-auto"
                                src="https://static-cse.canva.com/blob/571754/monochromaticcolors.jpg" alt="portfolio image">
                        </div>
                    </div>
                </div>
            </div>
