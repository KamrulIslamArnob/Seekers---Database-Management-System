    ...
    <ul class="toggle__nav--menu relative z-20 invisible text-left pt-[53px] pb-[22px]">
      ...
      <li>
        <a href="portfolio.php?$userId=<?php echo $userId; ?>" class="flex items-center">
          ...
          <span
            class="toggle__nav--menu--label-wrapper relative block h-[45px] leading-[45px] text-primary dark:text-white uppercase text-[16px] before:content[''] before:absolute before:w-[3px] before:h-[16px] before:top-[50%] ltr:before:left-[20px] rtl:before:right-[18px]">
            <span class="toggle__nav--menu--label font-bold font-heebo block opacity-0">Projects</span>
          </span>
        </a>
      </li>
      ...
      <div class="container mx-auto">
        <div class="text-center relative">
          ...
          <span
            ...
            My <span class="text-accent1">Services</span></span>
        </div>
      </div>
    </section>
          ...
          <?php foreach ($servicesData as $service): ?>
            <div
              ...
              <div class="overflow-hidden px-[30px] xl:px-[40px] lg:pt-[50px] md:pt-[40px] pb-[40px] ">
                ...
                <a href="#"
                  class="link-button text-[#48CDA0] before:bg-[#48CDA0] mt-[15px] hover:text-[#333] dark:hover:text-white">
                  Take Service
                </a>
              </div>
            </div>
