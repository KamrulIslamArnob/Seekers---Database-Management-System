...
if(isset($_POST["blog_id"]) && !empty($_POST["blog_id"])){
    ...
    $fileColumns = [];
    if (isset($tables_and_columns_names['blogs']['columns'])) {
        foreach ($tables_and_columns_names['blogs']['columns'] as $columnName => $columnDetails) {
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) . "?blog_id=" . $_GET["blog_id"]; ?>" method="post">
                    <?php print_error_if_exists(@$error); ?>
                        <div class="alert alert-danger fade-in">
                            <input type="hidden" name="blog_id" value="<?php echo trim($_GET["blog_id"]); ?>"/>
                    ...
                    <hr>
                    <p>
                        <a href="blogs-read.php?blog_id=<?php echo $_GET["blog_id"];?>" class="btn btn-info"><?php translate('View Record') ?></a>
