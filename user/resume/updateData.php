...
if (isset($_GET['action']) && isset($_GET['resume_id']) && isset($_GET['user_id'])) {
    // Retrieve the values
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    // Assuming you have a table named 'resumes' in your database
    // Make sure to sanitize and validate your data before updating the database
    // Example: $resumeTitle = mysqli_real_escape_string($connection, $resumeTitle);
    
    // Include your database connection file or configure it here
    // Example: include('db_connection.php');

    // Update the data in the 'resumes' table
    $query = "UPDATE resumes SET resumeTitle = '$resumeTitle' WHERE user_id = '$user_id'";
    // Execute the query
    ...
    // Example: mysqli_close($connection);
}
                ...
                <li>
                    <ul class="flex flex-wrap gap-4 text-gray-800 ">
                        <li
                            ...
                            <a href="<?php echo $userData['Whatsapp']; ?> " class="social-link"><i class="uil uil-whatsapp"></i></a></li>
                        <li
                            class="transition-all duration-200 ease-in hover:text-green-500 dark:text-gray-50 dark:hover:text-green-500">
                        ...
                        <li
                            class="transition-all duration-200 ease-in hover:text-green-500 dark:text-gray-50 dark:hover:text-green-500">
                            <a href="<?php echo $userData['email']; ?> " class="social-link"><i class="uil uil-envelope"></i></a></li>
                        <li
                            class="transition-all duration-200 ease-in hover:text-green-500 dark:text-gray-50 dark:hover:text-green-500">
                            <a href="<?php echo $userData['Github']; ?> " class="social-link"><i class="uil uil-twitter-alt"></i></a>
                        </li>
                    </ul>
                </li>
            </ul>
...
<nav class="navbar fixed right-0 left-0 top-0 lg:top-[44.5px] px-5 lg:px-24 transition-all duration-500 ease shadow-lg shadow-gray-200/20 bg-white border-gray-200 dark:bg-neutral-800 z-40 dark:shadow-neutral-900"
            ...
            <div id="navbar-collapse"
                ...
                <ul class="flex flex-col items-start mt-5 mb-10 font-medium lg:mt-0 lg:mb-0 lg:items-center lg:flex-row"
                    ...
                    <li class="relative dropdown lg:mt-0">
                        <a href="../companies.php" class="py-5 text-gray-800 lg:px-4 dropdown-toggle dark:text-gray-50 lg:h-[70px]"
                    ...
                    <li class="py-5 lg:px-4">
                        <a href="../portfolio/contact.php" class="py-2.5 text-gray-800 font-medium leading-tight dark:text-gray-50"
                            id="contact" data-bs-toggle="dropdown">Contact </a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <form action="submit" method="POST" enctype="multipart/form-data" class="w-full max-w-lg p-8 bg-white shadow-lg">
...
<div class="mt-5 grid grid-cols-12 gap-6">
    ...
    <div class="col-span-12 lg:col-span-6">
        <div class="mb-3">
            <label for="user_id" class="text-sm text-gray-900 dark:text-gray-50">User Id</label>
            <input type="text" name="user_id"
                ...
                id="user_id" value="<?php echo $user_id ?>" disabled>
        </div>
    </div>
    ...
    <div class="col-span-12 lg:col-span-6">
        <div class="mb-3">
            <label for="resumeTitle" class="text-sm text-gray-900 dark:text-gray-50">Resume Title</label>
            <input type="text" name="resumeTitle"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="resumeTitle" value="">
        </div>
    </div>
    ...
    <div class="col-span-12 lg:col-span-6">
        <div class="mb-3">
            <label for="resume_id" class="text-sm text-gray-900 dark:text-gray-50">Resume Id</label>
            <input type="text" name="resume_id"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="resume_id" value="<?php echo $resume_id ?>" disabled>
        </div>
    </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="First_name" class="text-sm text-gray-900 dark:text-gray-50">First Name</label>
            <input type="text" name="First_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    </div>
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Middle_name" class="text-sm text-gray-900 dark:text-gray-50">Middle Name</label>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Last Name</label>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Your Image</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Designation</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Address</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Email</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Phone</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Summery</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-6">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Title</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-6">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Description</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Company/Organization</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Location</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Start Date</label>
            <input type="date" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    </div>
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">End Date</label>
            <input type="date" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">School</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Degree</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">City</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Project Name</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Project link</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
    ...
    <div class="col-span-12 lg:col-span-4">
        <div class="mb-3">
            <label for="Last_name" class="text-sm text-gray-900 dark:text-gray-50">Skills</label>
            <input type="text" name="Last_name"
                class="w-full mt-1 text-gray-500 border rounded border-gray-100/50 text-13 dark:bg-transparent dark:border-neutral-600"
                id="additionalField2" value="">
        </div>
