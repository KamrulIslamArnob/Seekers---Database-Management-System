...
function healBrokenUrl($brokenUrl) {
    // Replace backslashes with forward slashes
    $fixedUrl = str_replace('\\', '/', $brokenUrl);
...
// Get resume ID and user ID from URL parameters
$resumeId = isset($_GET['resume_id']) ? $_GET['resume_id'] : null;
$userId = isset($_GET['user_id']) ? $_GET['user_id'] : null;

// Check if resume ID and user ID are provided
if ($resumeId !== null && $userId !== null) {
    // Retrieve data for achievements, education, and experience
    $achievements = $userCRUD->getAchievementsByResumeId($resumeId);
    $education = $userCRUD->getEducationByResumeId($resumeId);
    $experience = $userCRUD->getExperienceByResumeId($resumeId);
    $about = $userCRUD->getAboutByResumeId($userId, $resumeId);
    $projects = $userCRUD->getProjectsByResumeId($resumeId);
    $skills = $userCRUD->getSkillsByResumeId($resumeId);
...
//
    ...
    echo "Resume ID or User ID is missing.";
}
?>
...
<body>
            ...
            <div class="navbar-content">
                <div class="brand-and-toggler">
                    <a href="index.html" class="navbar-brand">
                        ...
                        <span class="navbar-brand-text">Seekers <span> Resume Builder</span>
                    </a>
                        ...
                        <div class="cv-form-row cv-form-row-about">
                            <div class="cols-3">
                                <div class="form-elem">
                                    ...
                                    <input name="firstname" type="text" class="form-control firstname" id=""
                                        onkeyup="generateCV()" value="<?php echo $about['fn']; ?>">
                                ...
                                <div class="form-elem">
                                    ...
                                    <input name="middlename" type="text" class="form-control middlename" id=""
                                        onkeyup="generateCV()" placeholder="e.g. Herbert" value="<?php echo $about['Middle_name']; ?>">>
                                    <span class="form-text"></span>
                                </div>
                                <div class="form-elem">
                                    <label for="" class="form-label">Last Name</label>
                                    <input name="lastname" type="text" class="form-control lastname" id=""
                                        onkeyup="generateCV()" placeholder="e.g. Doe" value="<?php echo $about['last_name']; ?>">
                                    <span class="form-text"></span>
                                </div>
                            </div>
                            ...
                            <div class="cols-3">
                                <div class="form-elem">
                                    ...
                                    <input name="image" type="file" class="form-control image" id="" accept=""
                                        onchange="previewImage()">
                                </div>
                                <div class="form-elem">
                                    <label for="" class="form-label">Designation</label>
                                    <input name="designation" type="text" class="form-control designation" id=""
                                        onkeyup="generateCV()" placeholder="e.g. Sr.Accountants" value="<?php echo $about['designation']; ?>">
                                    <span class="form-text"></span>
                                </div>
                                <div class="form-elem">
                                    <label for="" class="form-label">Address</label>
                                    <input name="address" type="text" class="form-control address" id=""
                                        onkeyup="generateCV()" placeholder="e.g. Lake Street-23" value="<?php echo $about['address']; ?>">
                                    <span class="form-text"></span>
                                </div>
                            </div>
                            ...
                            <div class="cols-3">
                                <div class="form-elem">
                                    ...
                                    <input name="email" type="text" class="form-control email" id=""
                                        onkeyup="generateCV()" placeholder="e.g. johndoe@gmail.com" value="<?php echo $about['email']; ?>">
                                    <span class="form-text"></span>
                                </div>
                                <div class="form-elem">
                                    <label for="" class="form-label">Phone No:</label>
                                    <input name="phoneno" type="text" class="form-control phoneno" id=""
                                        onkeyup="generateCV()" placeholder="e.g. 456-768-798, 567.654.002" value="<?php echo $about['contact_information']; ?>">
                                    <span class="form-text"></span>
                                </div>
                                <div class="form-elem">
                                    <label for="" class="form-label">Summary</label>
                                    <input name="summary" type="text" class="form-control summary" id=""
                                        onkeyup="generateCV()" placeholder="e.g. Doe" value="<?php echo $about['summary']; ?>">
                                    <span class="form-text"></span>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="cols-2">
                                                        ...
                                                        <div class="form-elem">
                                                            ...
                                                            <input name="achieve_description" type="text"
                                                                ...
                                                                value="<?php echo $achievement['Description'] ?>">
                                                            <span class="form-text"></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="cols-3">
                                                    <div class="form-elem">
                                                        ...
                                                        <input name="exp_title" type="text" class="form-control exp_title" id=""
                                                            onkeyup="generateCV()"
                                                            value="<?php echo $exp['experience_title']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                    <div class="form-elem">
                                                        ...
                                                        <input name="exp_organization" type="text"
                                                            ...
                                                            value="<?php echo $exp['experience_company']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                    <div class="form-elem">
                                                        ...
                                                        <input name="exp_location" type="text" class="form-control exp_location"
                                                            ...
                                                            value="<?php echo $exp['experience_location']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="cols-3">
                                                    <div class="form-elem">
                                                        ...
                                                        <input name="exp_start_date" type="date"
                                                            ...
                                                            value="<?php echo $exp['experience_start_date']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                    <div class="form-elem">
                                                        ...
                                                        <input name="exp_end_date" type="date" class="form-control exp_end_date"
                                                            id="" onkeyup="generateCV()"
                                                            value="<?php echo $exp['experience_end_date']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                    <div class="form-elem">
                                                        <label for="" class="form-label">Description</label>
                                                        <input name="exp_description" type="text"
                                                            ...
                                                            value="<?php echo $exp['experience_description']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="cols-3">
                                                    <div class="form-elem">
                                                        ...
                                                        <input name="edu_school" type="text" class="form-control edu_school"
                                                            id="" onkeyup="generateCV()" value="<?php echo $edu['school']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                    <div class="form-elem">
                                                        <label for="" class="form-label">Degree</label>
                                                        <input name="edu_degree" type="text" class="form-control edu_degree"
                                                            id="" onkeyup="generateCV()" value="<?php echo $edu['degree']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                    <div class="form-elem">
                                                        <label for="" class="form-label">City</label>
                                                        <input name="edu_city" type="text" class="form-control edu_city" id=""
                                                            onkeyup="generateCV()" value="<?php echo $edu['city']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="cols-3">
                                                    <div class="form-elem">
                                                        ...
                                                        <input name="edu_start_date" type="date"
                                                            ...
                                                            value="<?php echo $edu['education_start_date']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                    <div class="form-elem">
                                                        <label for="" class="form-label">End Date</label>
                                                        <input name="edu_graduation_date" type="date"
                                                            ...
                                                            onkeyup="generateCV()"
                                                            value="<?php echo $edu['education_end_date']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                    <div class="form-elem">
                                                        <label for="" class="form-label">Description</label>
                                                        <input name="edu_description" type="text"
                                                            ...
                                                            value="<?php echo $edu['education_description']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="cols-3">
                                                    ...
                                                    <div class="form-elem">
                                                        ...
                                                        <input name="proj_description" type="text"
                                                            ...
                                                            value="<?php echo $project['project_description']; ?>">
                                                        <span class="form-text"></span>
                                                    </div>
                                                </div>
                                                <button data-repeater-delete type="button"
                                            ...
                                            <div class="cv-form-row cv-form-row-skills">
                                                <div class="form-elem">
                                                    ...
                                                    <input name="skill" type="text" class="form-control skill" id=""
                                                        onkeyup="generateCV()" value="<?php echo $skill['skill_name']; ?>">
                                                    <span class="form-text"></span>
                                                </div>
    ...
    <!-- custom js -->
    <script src="../../assets/js/resume/script.js"></script>
    <!-- app js -->
