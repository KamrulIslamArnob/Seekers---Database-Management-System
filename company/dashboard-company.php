                        ...
                        <div class="col-span-12 lg:col-span-7">
                            <div class="mb-3 ltr:mr-14 rtl:ml-14">
                                ...
                                <p class="text-lg font-light text-gray-500 whitespace-pre-line dark:text-gray-300">Find
                                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsa fugit saepe provident, unde totam officiis repellat ullam incidunt eveniet quas itaque, consequuntur temporibus suscipit inventore? Molestiae labore animi tempore neque.</p>
                            </div>
                            <form action="#">
                                        ...
                                        <div class="col-span-12 xl:col-span-4">
                                            <div class="h-full mt-3">
                                                <button
                                                    ...
                                                    type="submit"><i class="uil uil-search me-1"></i> Find Candidate</button>
                                            </div>
                                        </div><!--end col-->
                                    </div><!--end row-->
                                </div>
                                ...
                                <div class="grid items-center grid-cols-12 gap-5">
                                    <div class="col-span-12 lg:col-span-8 lg:col-start-3">
                                        <div class="text-center">
                                            <h2 class="mb-5 group-data-[theme-color=violet]:text-violet-500 group-data-[theme-color=sky]:text-sky-500 group-data-[theme-color=red]:text-red-500 group-data-[theme-color=green]:text-green-500 group-data-[theme-color=pink]:text-pink-500 group-data-[theme-color=blue]:text-blue-500">Browse Your <span class="text-yellow-500 fw-bold">Unapproved </span>Job
                                                Post</h2>
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="p-2 mt-3 transition-all duration-500 bg-white rounded shadow-lg shadow-gray-100/50 card dark:bg-neutral-800 dark:shadow-neutral-600/20 group/blog">
                        <div class="relative overflow-hidden">
                            <img src="../user/blog/blogCRUD/uploads/<?php echo $blogItem['blog_cover']; ?>" alt="" class="rounded">
                            ...
                            <div class="hidden text-white transition-all duration-500 top-2 left-2 group-hover/blog:block author group-hover/blog:absolute">
                                ...
                                <p class="mb-0 text-light date"><i class="mdi mdi-calendar-check"></i> <?php echo date('d F, Y', strtotime($blogItem['created_at'])); ?></p>
                            </div>
                        ...
                        <div class="p-5">
                            <a href="blog-details.php?blog_id=<?php echo $blogItem['blog_id']; ?>" class="primary-link">
                                <h5 class="mb-1 text-gray-900 fs-17 dark:text-gray-50"><?php echo $blogItem['blog_title']; ?></h5>
                            </a>
                            <p class="mb-3 text-gray-500 dark:text-gray-300"><?php echo $blogItem['blog_tagline']; ?></p>
                            <a href="blog-details.php?blog_id=<?php echo $blogItem['blog_id']; ?>" class="font-medium group-data-[theme-color=violet]:text-violet-500 group-data-[theme-color=sky]:text-sky-500 group-data-[theme-color=red]:text-red-500 group-data-[theme-color=green]:text-green-500 group-data-[theme-color=pink]:text-pink-500 group-data-[theme-color=blue]:text-blue-500">Read more <i class="align-middle mdi mdi-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
    <?php endforeach; ?>
